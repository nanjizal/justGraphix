...
import justGraphix.color.space.ARGB;
import justGraphix.color.space.RGB;
import justGraphix.color.space.CYMKA;
import justGraphix.color.space.CYMK;
...
abstract ColorInt( Int ) to Int from Int {
    ...
    @:to
    public inline
    function toSRLCH2(): SRLCH2 {
       final v1: Int = this;
       final v2: SRLCH2 = to_srlch2(v1);
       return v2;
    }
    @:to
    public inline
    ...
    function fromSRLAB2( c: SRLAB2 ): ColorInt {
        return new ColorInt( from_srlab2( new SRLAB2( c.L, c.a, c.b, c.alpha ) ) );
    }
    @:from
    static public inline
    function fromSRLCH2( c: SRLCH2 ): ColorInt {
        return new ColorInt( from_srlch2( c.L, c.c, c.h, c.alpha ) );
    }
    @:from
    static public inline
