...
import justGraphix.hit.HitTri;
    ...
    **/
    ...
    function topRightImgTriFudge( pixelImage: Pixelimage, texture: Pixelimage, win: RectangleWindow
                            ...
                            , cx: Float, cy: Float
                            , hasHit: Bool = false ): Null<HitTri>{
        return uvTriangle( pixelImage, texture, win, ax, ay, 1., 0., bx, by, 0., 0., cx, cy, 1., 1., hasHit );                      
    }
    inline
    function bottomLeftImgTriFudge( pixelImage: Pixelimage, texture: Pixelimage, win: RectangleWindow
                            ...
                            , ax: Float, ay: Float
                            , hasHit: Bool = false ): Null<HitTri>{
        return uvTriangle( pixelImage, texture, win, dx, dy, 1., 1., cx, cy, 0., 1., ax, ay, 0., 0., hasHit );                     
    }
    /**
    ...
    **/
    ...
    function topLeftImgTri( pixelImage: Pixelimage, texture: Pixelimage, win: RectangleWindow
        ...
        // tri e - a b d
        // tri f - b c d                        
        return uvTriangle( pixelImage, texture, win, ax, ay, 0., 0., bx, by, 1, 0., dx, dy, 0., 1., hasHit );                      
    }
    inline
    function bottomRightImgTri( pixelImage: Pixelimage, texture: Pixelimage, win: RectangleWindow
        ...
        // tri e - a b d
        // tri f - b c d                         
        return uvTriangle( pixelImage, texture, win, bx, by, 1., 0., cx, cy, 1., 1., dx, dy, 0., 1., hasHit );                     
    }
    inline
