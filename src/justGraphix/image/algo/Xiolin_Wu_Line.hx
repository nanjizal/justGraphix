...
*/
inline
function xWuLineNoEnd( pixelImage: Pixelimage
                , x0: Float, y0: Float
                , x1: Float, y1: Float
...
class Xiolin_Wu_Line {
    public static inline function xWuLineNoEnd_( pixelImage: Pixelimage
        , x0: Float, y0: Float
        , x1: Float, y1: Float
        , color: Pixel32, brightRange: Float = 0.25
        ): Void {
        return xWuLineNoEnd( pixelImage, x0, y0, x1, y1, color, brightRange );
    }
