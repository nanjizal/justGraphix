...
import justGraphix.image.algo.PentagonSampler;
import justGraphix.hit.HitTriScalar;
import justGraphix.image.algo.Barycentric;
...
function triGradPentBaryBottom( pixelImage: Pixelimage
    ...
    return triGradPentBary( pixelImage, ax, ay, colorA, bx, by, colorB, cx, cy, colorC, softAB, softBC, softCA, hasHit );
} 
inline
