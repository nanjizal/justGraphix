...
import justGraphix.iterMagic.BoundIterator;
import justGraphix.iterMagic.IteratorRange;
import justGraphix.image.ImageStruct;
...
import justGraphix.iterMagic.IteratorRangeXY;
...
import justGraphix.image.imageAbstracts.FillShape;
import justGraphix.image.imageAbstracts.SoftShape;
import justGraphix.image.imageAbstracts.AnsiImage;
import justGraphix.image.imageAbstracts.ColorformImage;
import justGraphix.image.imageAbstracts.Convolution;
import justGraphix.image.imageAbstracts.GradientShape;
...
import justGraphix.target._canvas.JsCanvasContext;
/*
    import pi_xy.imageAbstracts.*;
