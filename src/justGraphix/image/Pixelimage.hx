...
import justGraphix.iterMagix.IteratorRangeXY;
...
abstract Pixelimage(ImageStruct) from ImageStruct to ImageStruct {
    ...
    **/
    ...
    public //inline
    function new(width:Int, height:Int, imageType:Null<ImageType> = null) {
