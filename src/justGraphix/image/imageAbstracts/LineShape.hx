...
import justGraphix.image.algo.Xiolin_Wu_Line;
import justGraphix.image.algo.Xiolin_Wu_Line.xWuLine;
import justGraphix.color.ColorHelp;
import justGraphix.contour.contourPath.DrawShapeHelper;
import justGraphix.contour.contourPath.DrawThinLineHelper;
...
abstract LineShape( Pixelimage ) from Pixelimage to Pixelimage {
    ...
    function thinLine( ax: Float, ay: Float
        ...
        return new justGraphix.hit.HitThinLine( ax, ay, bx, by );
    }
    public inline
