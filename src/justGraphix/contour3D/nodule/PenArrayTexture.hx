...
import justGraphix.contour3D.io.FlatArrayTrianglesUV;
import justGraphix.contour3D.drawing.Pen;
import justGraphix.contour3D.drawing.TriangleAbstract;
import justGraphix.contour3D.drawing.TriangleAbstractUV;
...
class PenArrTexture extends PenNodule {
    public var colorTriangles   = new FlatArrayTrianglesUV();
