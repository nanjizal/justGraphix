...
import justGraphix.contour3D.io.FloatColorTrianglesUV;
...
@:transitive
@:forward
abstract FlatColorTrianglesUV( FloatColorTrianglesUV ) from FloatColorTrianglesUV to FloatColorTrianglesUV {
    @:to
    public inline
    ...
    public inline function new( len: Int ){
        this = new FloatColorTrianglesUV( len );
    }
    public
