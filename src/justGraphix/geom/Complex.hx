...
import justGraphix.geom.Matrix1x2;
import justGraphix.geom.Polar;
import justGraphix.curve.Hyperbolic;
import justGraphix.curve.ComplexTrig;
/**
...
@:forward
abstract Complex( justGraphix.geom.structs.Mat1x2 ) from justGraphix.geom.structs.Mat1x2 to justGraphix.geom.structs.Mat1x2 {
    /**
     * <pre><code>
     * >>> ({ 
     * ... var c0: Complex = '1 + 2i';
    ...
    public inline
    function new( m: justGraphix.geom.structs.Mat1x2 ){ this = m; }
    /** 
     * <pre><code>
     * >>> ({
    ...
    */
    ...
    function fromPolar( polar: Polar ) {
      return new Complex({ 
              x: polar.magnitude * Math.cos( polar.phase )
            , y: polar.magnitude * Math.sin( polar.phase ) } );
    }
