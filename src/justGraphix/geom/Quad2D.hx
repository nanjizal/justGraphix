...
import justGraphix.geom.structs.Quad2DStruct;
import justGraphix.geom.structs.Rectangle;
@:forward
@:transitive
@:access( justGraphix.geom.structs.Quad2DStruct )
abstract Quad2D( Quad2DStruct ) to Quad2DStruct from Quad2DStruct {
    public inline function new( quad: Quad2DStruct ){
        this = quad;
    }
