...
abstract Rectangle( RectangleStruct ) to RectangleStruct from RectangleStruct {
    public inline function new( rectangle: RectangleStruct ){
        this = rectangle;
    }
