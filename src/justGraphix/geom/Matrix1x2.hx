...
import justGraphix.constraints.Interval;
...
@:transitive
@:forward
abstract Matrix1x2( Mat1x2 ) from Mat1x2 to Mat1x2 {
    public static inline 
    final rows = 1;
    public static inline
    final columns = 2;
    public inline
    function new( m: Mat1x2 ){ this = m; }
                //-------------------
...
// < 0, p is righ of line, clockwise
    ...
    @:to
    public inline
    function toTpoint():justGraphix.geom.structs.Mat1x2.Tpoint return Conversion._1x2toTpoint( this );
    /**
     * <pre><code>
     * >>> ({ 
