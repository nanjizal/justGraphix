...
import justGraphix.geom.*;
import justGraphix.geom.structs.*;
import justGraphix.geom.Matrix4x4;
import justGraphix.geom.structs.Mat1x2.Tpoint;
import justGraphix.geom.structs.Mat2x2.Tmatrix2x2;
import justGraphix.geom.structs.Mat2x2.Tmatrix2x2numbered;
import justGraphix.geom.structs.Mat2x2.Alternate2x2numbered;
import justGraphix.geom.structs.Mat3x3.Tmatrix3x3;
import justGraphix.geom.structs.Mat3x3.Alternate3x3numbered;
import justGraphix.geom.structs.Mat3x3.Tmatrix3x3numbered;
import justGraphix.geom.structs.Mat4x4.Tmatrix4x4;
import justGraphix.geom.structs.Mat4x4.Alternate4x4numbered;
import justGraphix.geom.structs.Mat4x4.Tmatrix4x4numbered;
import justGraphix.geom.structs.Mat4x3.TAffineMatrix;
import justGraphix.geom.structs.Mat4x3.Tmatrix4x3;

// collected matrix conversions
class Conversion {
    // 1x2
    public static inline
    function _1x2toTpoint( m1x2: Matrix1x2 ):Tpoint {
    ...
    function Float32Array_to4x4Transpose( arr: Float32Array ): Matrix4x4 {
        var m: Mat4x4 = { a: arr[0],  b: arr[4],  c: arr[8],  d: arr[12]
                        , e: arr[1],  f: arr[5],  g: arr[9],  h: arr[13]
                        , i: arr[2],  j: arr[6],  k: arr[10], l: arr[14]
    ...
    function Alternate4x4numberedto4x4( tm: Alternate4x4numbered ): Matrix4x4 {
        var m: Mat4x4 = { a: tm._00, b: tm._01, c: tm._02, d: tm._03
