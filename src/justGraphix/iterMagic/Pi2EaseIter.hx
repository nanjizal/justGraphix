...
import justGraphix.iterMagic.Pi2Iterator;
...
@:transitive
@:access( IntIterator.min, IntIterator.max )
@:access( justGraphix.iterMagic.Pi2EasyIter.includeMax )
@:access( justGraphix.iterMagic.Pi2EasyIter.count )
@:access( justGraphix.iterMagic.Pi2EasyIter.startRadian )
@:access( justGraphix.iterMagic.Pi2EasyIter.deltaRadian )
@:access( justGraphix.iterMagic.Pi2EasyIter.finish )
@:access( justGraphix.iterMagic.Pi2EasyIter.ease )
@:access( justGraphix.iterMagic.Pi2EasyIter.value )
@:access( justGraphix.iterMagic.Pi2Iterator.small )
@:forward
