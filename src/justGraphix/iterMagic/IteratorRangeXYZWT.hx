...
//import justGraphix.iterMagic.IntIterator;
...
abstract IteratorRangeXYZWT( IntIterXYZWT ) from IntIterXYZWT {
    public inline function new( xRange: IteratorRange
                              , yRange: IteratorRange
                              , zRange: IteratorRange
                              , wRange: IteratorRange 
                              , tRange: IteratorRange ) {
        this = new IntIterXYZWT( xRange, yRange, zRange, wRange, tRange );
    }
	...
	static inline public function fromRect5D( r: { x: Int, w: Int
		                                        ...
		                                        ,  z: Int, d: Int
		                                        ,  u: Int, v: Int
                                                ,  t: Int, s: Int } ): IteratorRangeXYZWT {
		var xmax = r.x + r.w + 1;
		var ymax = r.y + r.h + 1;
		var zmax = r.z + r.d + 1;
		var wmax = r.u + r.v + 1;
		var tmax = r.t + r.s + 1;
		return new IteratorRangeXYZWT(r.x...xmax, r.y...ymax, r.z...zmax, r.u...wmax, r.t...tmax );
	}
