package justGraphix.pallette.metal;
...
class Gold {
    ...
    function getColors (): Array<Golds> {
        return  [ rolex
                , periniNavi
                , crownRoyal
                , metallic
...
class AllGold {
    inline public static 
    function getColors (): Array<AllGolds> {
        return  [ 
              old_Lace
            , linen
            , cornsilk
    ...
    inline public static
    function getName( g: AllGolds ): String {
        return switch( g ){
