package justGraphix.pallette.wheel;

#if noAlphaHex 
enum abstract Reds( Int ) to Int from Int {
...
enum abstract Oranges( Int ) to Int from Int {
...
enum abstract Turmeric( Int ) to Int from Int {
    var buff           = 0xFFDAA6;
...
enum abstract YellowCheese( Int ) to Int from Int {
...
enum abstract Yellows( Int ) to Int from Int {
  var butter          = 0xFFFFA6;
  var yellow          = 0xFFFF00;
  var wasabi          = 0xC4C400;
  var olive           = 0x8A8A00;
...
enum abstract GreenGrape( Int ) to Int from Int {
...
enum abstract Chartreuse( Int ) to Int from Int {
...
enum abstract GreenPea( Int ) to Int from Int {
...
enum abstract Green( Int ) to Int from Int {
...
enum abstract Clover( Int ) to Int from Int {
...
enum abstract Emerald( Int ) to Int from Int {
...
enum abstract Malachite( Int ) to Int from Int {
...
enum abstract Cyan( Int ) to Int from Int {
...
enum abstract Turquoise( Int ) to Int from Int {
    var uranus        = 0x99DDFF;
...
enum abstract Azure( Int ) to Int from Int {
...
enum abstract RoyalBlue( Int ) to Int from Int {
...
enum abstract Blue( Int ) to Int from Int {
...
enum abstract Dioxazine( Int ) to Int from Int {
...
enum abstract Violet( Int ) to Int from Int {
    var mauve        = 0xE9BFFF;
...
enum abstract Aniline( Int ) to Int from Int {
    var lilac        = 0xF4BFFF;
...
enum abstract Magenta( Int ) to Int from Int {
...
enum abstract Bougainville( Int ) to Int from Int {
...
enum abstract Pink( Int ) to Int from Int {
...
enum abstract RedPlum( Int ) to Int from Int {
