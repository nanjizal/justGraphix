package justGraphix.contour.shape;
import justGraphix.contour.IPen;
import justGraphix.rose.Angles;
import justGraphix.contour.shape.Circles;
import justGraphix.contour.shape.Ellipses;
import justGraphix.geom.Quad2D;
import justGraphix.contour.shape.Pies;
import justGraphix.contour.shape.Lines;
import justGraphix.contour.shape.Quads;
inline
