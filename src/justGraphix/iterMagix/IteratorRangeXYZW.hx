...
//import justGraphix.iterMagixIntIterator;
...
abstract IteratorRangeXYZW( IntIterXYZW ) from IntIterXYZW {
	public inline
    function new( xRange: IteratorRange, yRange: IteratorRange, zRange: IteratorRange, wRange: IteratorRange ){
        this = new IntIterXYZW( xRange, yRange, zRange, wRange );
    }
    @:from
    static inline
    ...
    public function fromRect4D( r: { x: Int, w: Int, y: Int, h: Int, z: Int, d: Int, u: Int, v: Int } ): IteratorRangeXYZW {
        ...
        var zmax = r.z + r.d + 1;
        var wmax = r.u + r.v + 1;
        return new IteratorRangeXYZW( r.x...xmax, r.y...ymax, r.z...zmax, r.w...wmax );
    }
    public inline
