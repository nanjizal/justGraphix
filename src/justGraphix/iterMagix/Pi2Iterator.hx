...
@:transitive
@:access( IntIterator.min, IntIterator.max )
@:access( justGraphix.iterMagix.Pi2Iter.includeMax )
@:access( justGraphix.iterMagix.Pi2Iter.count )
@:access( justGraphix.iterMagix.Pi2Iter.startRadian )
@:access( justGraphix.iterMagix.Pi2Iter.stepFactor )
@:access( justGraphix.iterMagix.Pi2Iter.value )
@:forward
