...
import justGraphix.iterMagix.Pi2Iterator;
...
@:transitive
@:access( IntIterator.min, IntIterator.max )
@:access( justGraphix.iterMagix.Pi2EasyIter.includeMax )
@:access( justGraphix.iterMagix.Pi2EasyIter.count )
@:access( justGraphix.iterMagix.Pi2EasyIter.startRadian )
@:access( justGraphix.iterMagix.Pi2EasyIter.deltaRadian )
@:access( justGraphix.iterMagix.Pi2EasyIter.finish )
@:access( justGraphix.iterMagix.Pi2EasyIter.ease )
@:access( justGraphix.iterMagix.Pi2EasyIter.value )
@:access( justGraphix.iterMagix.Pi2Iterator.small )
@:forward
