package justGraphix.fracs;
import justGraphix.fracs.Fraction;
// ported to Haxe by Justin L Mills
// Originally found at http://www.mindspring.com/~alanh/fracs.html.
// Retrieved from https://web.archive.org/web/20190107195704/http://www.mindspring.com/~alanh/fracs.html on May 20, 2019. 
...
class Fracs {
    ...
    @:allow(justGraphix.fracs.Fraction)
    static
