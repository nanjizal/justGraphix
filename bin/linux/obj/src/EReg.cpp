...
HX_LOCAL_STACK_FRAME(_hx_pos_dd170729d725082f_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","EReg.hx",98,0x6a3d6c0f)
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_dd170729d725082f_98_replace)
