...
HX_DEFINE_STACK_FRAME(_hx_pos_f3d6fa47fdac4afe_171_new,"sys.thread._Thread.HaxeThread","new",0x28e1daea,"sys.thread._Thread.HaxeThread.new","sys/thread/Thread.hx",171,0xb2b901d1)
HX_LOCAL_STACK_FRAME(_hx_pos_b3cdb9a1226d5623_79___init__,"::sys::thread::_Thread::HaxeThread_obj","__init__",0x85b0f2c4,"::sys::thread::_Thread::HaxeThread_obj.__init__","sys/thread/Thread.hx",79,0xb2b901d1)
HX_LOCAL_STACK_FRAME(_hx_pos_f3d6fa47fdac4afe_91_current,"sys.thread._Thread.HaxeThread","current",0xca8ab3c3,"sys.thread._Thread.HaxeThread.current","sys/thread/Thread.hx",91,0xb2b901d1)
namespace sys{
namespace thread{
namespace _Thread{

void HaxeThread_obj::__construct( ::Dynamic h){
            	HX_STACKFRAME(&_hx_pos_f3d6fa47fdac4afe_171_new)
...
void HaxeThread_obj::__init__(){
            	HX_GC_STACKFRAME(&_hx_pos_b3cdb9a1226d5623_79___init__)
...
::Array< ::Dynamic> HaxeThread_obj::threads;
 ...
 ::sys::thread::_Thread::HaxeThread HaxeThread_obj::current(){
            	HX_GC_STACKFRAME(&_hx_pos_f3d6fa47fdac4afe_91_current)
