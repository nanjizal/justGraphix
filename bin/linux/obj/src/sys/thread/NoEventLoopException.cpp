...
HX_DEFINE_STACK_FRAME(_hx_pos_11309ef1d70e42a6_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","sys/thread/NoEventLoopException.hx",7,0x748cc8e9)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_11309ef1d70e42a6_7_new)
