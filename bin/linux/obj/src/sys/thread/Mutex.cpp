...
HX_DEFINE_STACK_FRAME(_hx_pos_a56354d001f38b1f_30_new,"sys.thread.Mutex","new",0x0051f1ae,"sys.thread.Mutex.new","sys/thread/Mutex.hx",30,0xada5efa2)
HX_LOCAL_STACK_FRAME(_hx_pos_a56354d001f38b1f_34_acquire,"sys.thread.Mutex","acquire",0xae482c24,"sys.thread.Mutex.acquire","sys/thread/Mutex.hx",34,0xada5efa2)
HX_LOCAL_STACK_FRAME(_hx_pos_a56354d001f38b1f_42_release,"sys.thread.Mutex","release",0x52516615,"sys.thread.Mutex.release","sys/thread/Mutex.hx",42,0xada5efa2)
namespace sys{
namespace thread{

void Mutex_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a56354d001f38b1f_30_new)
...
void Mutex_obj::acquire(){
            	HX_STACKFRAME(&_hx_pos_a56354d001f38b1f_34_acquire)
...
void Mutex_obj::release(){
            	HX_STACKFRAME(&_hx_pos_a56354d001f38b1f_42_release)
