...
HX_DEFINE_STACK_FRAME(_hx_pos_50b2f25a41957995_24_new,"sys.thread.EventLoop","new",0xafe12fcd,"sys.thread.EventLoop.new","sys/thread/EventLoop.hx",24,0x6b7faa63)
HX_LOCAL_STACK_FRAME(_hx_pos_50b2f25a41957995_146_progress,"sys.thread.EventLoop","progress",0xd3ab8d20,"sys.thread.EventLoop.progress","sys/thread/EventLoop.hx",146,0x6b7faa63)
HX_LOCAL_STACK_FRAME(_hx_pos_50b2f25a41957995_179_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","sys/thread/EventLoop.hx",179,0x6b7faa63)
namespace sys{
namespace thread{

void EventLoop_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_50b2f25a41957995_24_new)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_STACKFRAME(&_hx_pos_50b2f25a41957995_146_progress)
...
HXLINE( 146)			goto _hx_goto_6;
            		...
            		/* default */{
HXDLIN( 146)			if (_ganyTime) {
HXLINE( 150)				Float time = _gnextEventAt;
HXDLIN( 150)				return ::sys::thread::NextEventTime_obj::AnyTime(time);
            			}
            			else {
HXLINE( 151)				Float time1 = _gnextEventAt;
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_50b2f25a41957995_179_loop)
...
HXLINE( 184)					goto _hx_goto_14;
            				...
            				/* default */{
HXLINE( 190)					Float time = _gnextEventAt;
HXDLIN( 190)					{
