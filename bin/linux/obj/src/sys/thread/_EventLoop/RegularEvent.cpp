...
HX_DEFINE_STACK_FRAME(_hx_pos_34eca1b67e0f214d_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","sys/thread/EventLoop.hx",278,0x6b7faa63)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_34eca1b67e0f214d_278_new)
