...
HX_DEFINE_STACK_FRAME(_hx_pos_40a83ac3d924101d_1158_new,"peote.view.ActiveTexture","new",0xdc8bb601,"peote.view.ActiveTexture.new","peote/view/Program.hx",1158,0x6b0a9d00)
namespace peote{
namespace view{

void ActiveTexture_obj::__construct(int unit, ::peote::view::Texture texture,int uniformLoc){
            	HX_STACKFRAME(&_hx_pos_40a83ac3d924101d_1158_new)
HXLINE(1159)		this->unit = unit;
HXLINE(1160)		this->texture = texture;
HXLINE(1161)		this->uniformLoc = uniformLoc;
            	}
