...
HX_DEFINE_STACK_FRAME(_hx_pos_83dcfa03fc3b682f_4_new,"peote.view.intern.RenderList_peote_view_ActiveTexture","new",0x7b0a5336,"peote.view.intern.RenderList_peote_view_ActiveTexture.new","peote/view/intern/RenderList.hx",4,0x1775adb3)
HX_LOCAL_STACK_FRAME(_hx_pos_83dcfa03fc3b682f_20_add,"peote.view.intern.RenderList_peote_view_ActiveTexture","add",0x7b0074f7,"peote.view.intern.RenderList_peote_view_ActiveTexture.add","peote/view/intern/RenderList.hx",20,0x1775adb3)
HX_LOCAL_STACK_FRAME(_hx_pos_83dcfa03fc3b682f_100_clear,"peote.view.intern.RenderList_peote_view_ActiveTexture","clear",0xbfd8d5e3,"peote.view.intern.RenderList_peote_view_ActiveTexture.clear","peote/view/intern/RenderList.hx",100,0x1775adb3)
namespace peote{
namespace view{
namespace intern{

void RenderList_peote_view_ActiveTexture_obj::__construct( ::haxe::ds::ObjectMap itemMap){
            	HX_STACKFRAME(&_hx_pos_83dcfa03fc3b682f_4_new)
...
bool RenderList_peote_view_ActiveTexture_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x6f694b18;
}
...
void RenderList_peote_view_ActiveTexture_obj::add( ::peote::view::ActiveTexture value, ::peote::view::ActiveTexture atValue,bool addBefore){
            	HX_GC_STACKFRAME(&_hx_pos_83dcfa03fc3b682f_20_add)
HXLINE(  21)		 ::peote::view::intern::RenderListItem_peote_view_ActiveTexture newItem = null();
HXLINE(  23)		if (addBefore) {
HXLINE(  25)			if (::hx::IsNull( this->first )) {
HXLINE(  25)				newItem = (this->first = (this->last =  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture_obj::__alloc( HX_CTX ,value,null(),null())));
            			}
            			else {
HXLINE(  28)				if (::hx::IsNull( atValue )) {
HXLINE(  29)					newItem = (this->first =  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture_obj::__alloc( HX_CTX ,value,null(),this->first));
            				}
            				else {
HXLINE(  31)					 ::peote::view::intern::RenderListItem_peote_view_ActiveTexture atItem = ( ( ::peote::view::intern::RenderListItem_peote_view_ActiveTexture)(::haxe::IMap_obj::get(this->itemMap,atValue)) );
HXLINE(  32)					if (::hx::IsNotNull( atItem )) {
HXLINE(  33)						newItem =  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture_obj::__alloc( HX_CTX ,value,atItem->prev,atItem);
...
HXLINE(  42)				newItem = (this->first = (this->last =  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture_obj::__alloc( HX_CTX ,value,null(),null())));
            			}
            			else {
HXLINE(  45)				if (::hx::IsNull( atValue )) {
HXLINE(  46)					newItem = (this->last =  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture_obj::__alloc( HX_CTX ,value,this->last,null()));
            				}
            				else {
HXLINE(  48)					 ::peote::view::intern::RenderListItem_peote_view_ActiveTexture atItem1 = ( ( ::peote::view::intern::RenderListItem_peote_view_ActiveTexture)(::haxe::IMap_obj::get(this->itemMap,atValue)) );
HXLINE(  49)					if (::hx::IsNotNull( atItem1 )) {
HXLINE(  50)						newItem =  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture_obj::__alloc( HX_CTX ,value,atItem1,atItem1->next);
...
HXLINE(  59)		 ::peote::view::intern::RenderListItem_peote_view_ActiveTexture oldItem = ( ( ::peote::view::intern::RenderListItem_peote_view_ActiveTexture)(::haxe::IMap_obj::get(this->itemMap,value)) );
HXLINE(  60)		if (::hx::IsNotNull( oldItem )) {
HXLINE(  60)			 ::peote::view::intern::RenderListItem_peote_view_ActiveTexture item = oldItem;
...
void RenderList_peote_view_ActiveTexture_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_83dcfa03fc3b682f_100_clear)
...
HXLINE( 102)			{
HXLINE( 102)				 ::peote::view::intern::RenderListItem_peote_view_ActiveTexture item = this->last;
...
::hx::ObjectPtr< RenderList_peote_view_ActiveTexture_obj > RenderList_peote_view_ActiveTexture_obj::__alloc(::hx::Ctx *_hx_ctx, ::haxe::ds::ObjectMap itemMap) {
	RenderList_peote_view_ActiveTexture_obj *__this = (RenderList_peote_view_ActiveTexture_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(RenderList_peote_view_ActiveTexture_obj), true, "peote.view.intern.RenderList_peote_view_ActiveTexture"));
...
::hx::Val RenderList_peote_view_ActiveTexture_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"last") ) { last=inValue.Cast<  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture >(); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"first") ) { first=inValue.Cast<  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture >(); return inValue; }
		break;
	case 7:
...
static ::hx::StorageInfo RenderList_peote_view_ActiveTexture_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture */ ,(int)offsetof(RenderList_peote_view_ActiveTexture_obj,first),HX_("first",30,78,9d,00)},
	{::hx::fsObject /*  ::peote::view::intern::RenderListItem_peote_view_ActiveTexture */ ,(int)offsetof(RenderList_peote_view_ActiveTexture_obj,last),HX_("last",56,0a,ad,47)},
...
void RenderList_peote_view_ActiveTexture_obj::__register()
{
	...
	__mClass->mName = HX_("peote.view.intern.RenderList_peote_view_ActiveTexture",44,40,6f,2c);
