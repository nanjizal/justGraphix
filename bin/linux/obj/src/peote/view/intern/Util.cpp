...
HX_LOCAL_STACK_FRAME(_hx_pos_4f0b4d964e76f3b8_26_resolveFormulaCyclic,"peote.view.intern.Util","resolveFormulaCyclic",0x1dda5269,"peote.view.intern.Util.resolveFormulaCyclic","peote/view/intern/Util.hx",26,0x76a45085)
HX_LOCAL_STACK_FRAME(_hx_pos_4f0b4d964e76f3b8_39_resolveFormulaKey,"peote.view.intern.Util","resolveFormulaKey",0x0ac3f9af,"peote.view.intern.Util.resolveFormulaKey","peote/view/intern/Util.hx",39,0x76a45085)
HX_LOCAL_STACK_FRAME(_hx_pos_4f0b4d964e76f3b8_67_resolveFormulaVars,"peote.view.intern.Util","resolveFormulaVars",0x67f8c99c,"peote.view.intern.Util.resolveFormulaVars","peote/view/intern/Util.hx",67,0x76a45085)
namespace peote{
namespace view{
namespace intern{
...
bool Util_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0d670a64;
}

void Util_obj::resolveFormulaCyclic( ::haxe::ds::StringMap formulas){
            	HX_GC_STACKFRAME(&_hx_pos_4f0b4d964e76f3b8_26_resolveFormulaCyclic)
...
HXLINE(  30)				 ::Dynamic err = ::peote::view::intern::Util_obj::resolveFormulaKey(k1,formulas,resolved,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Util_obj,resolveFormulaCyclic,(void))
 ...
 ::Dynamic Util_obj::resolveFormulaKey(::String key, ::haxe::ds::StringMap formulas,::Array< ::String > resolved,::Array< ::String > fromKeys){
            	HX_GC_STACKFRAME(&_hx_pos_4f0b4d964e76f3b8_39_resolveFormulaKey)
...
HXLINE(  54)						 ::Dynamic f = ::peote::view::intern::Util_obj::resolveFormulaKey(k1,formulas,resolved,fromKeys->concat(::Array_obj< ::String >::__new(1)->init(0,k1)));
...
void Util_obj::resolveFormulaVars( ::haxe::ds::StringMap formulas, ::haxe::ds::StringMap attribs){
            	HX_GC_STACKFRAME(&_hx_pos_4f0b4d964e76f3b8_67_resolveFormulaVars)
...
void Util_obj::__register()
{
	...
	__mClass->mName = HX_("peote.view.intern.Util",b8,cb,a1,c0);
