...
HX_LOCAL_STACK_FRAME(_hx_pos_89eec3eef0260e88_126_run,"haxe.EntryPoint","run",0xf0324cc3,"haxe.EntryPoint.run","haxe/EntryPoint.hx",126,0x47c59ff7)
namespace haxe{
...
void EntryPoint_obj::run(){
            	HX_STACKFRAME(&_hx_pos_89eec3eef0260e88_126_run)
            	}
