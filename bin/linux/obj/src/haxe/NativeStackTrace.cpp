...
HX_LOCAL_STACK_FRAME(_hx_pos_597ca6a1528b5b0c_12_saveStack,"haxe.NativeStackTrace","saveStack",0x471b27d9,"haxe.NativeStackTrace.saveStack","haxe/NativeStackTrace.hx",12,0x14a4b0e1)
HX_LOCAL_STACK_FRAME(_hx_pos_597ca6a1528b5b0c_25_toHaxe,"haxe.NativeStackTrace","toHaxe",0x6b36d173,"haxe.NativeStackTrace.toHaxe","haxe/NativeStackTrace.hx",25,0x14a4b0e1)
namespace haxe{
...
void NativeStackTrace_obj::saveStack( ::Dynamic exception){
            	HX_STACKFRAME(&_hx_pos_597ca6a1528b5b0c_12_saveStack)
            	}
...
::Array< ::Dynamic> NativeStackTrace_obj::toHaxe(::Array< ::String > native,::hx::Null< int >  __o_skip){
            	...
            	HX_STACKFRAME(&_hx_pos_597ca6a1528b5b0c_25_toHaxe)
