...
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_88_blit,"haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","haxe/io/Bytes.hx",88,0x68bfff33)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_310_setFloat,"haxe.io.Bytes","setFloat",0xdaed805d,"haxe.io.Bytes.setFloat","haxe/io/Bytes.hx",310,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_406_getString,"haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","haxe/io/Bytes.hx",406,0x68bfff33)
HX_LOCAL_STACK_FRAME(_hx_pos_7de8773c9a509473_498_toString,"haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","haxe/io/Bytes.hx",498,0x68bfff33)
...
void Bytes_obj::setFloat(int pos,Float v){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_310_setFloat)
HXLINE( 319)		bool _hx_tmp;
HXDLIN( 319)		if ((pos >= 0)) {
HXLINE( 319)			_hx_tmp = ((pos + 4) > this->length);
            		}
            		else {
HXLINE( 319)			_hx_tmp = true;
            		}
HXDLIN( 319)		if (_hx_tmp) {
HXLINE( 320)			HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            		}
HXLINE( 321)		 ::__hxcpp_memory_set_float(this->b,pos,v);
            	}
...
::String Bytes_obj::getString(int pos,int len, ::haxe::io::Encoding encoding){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_406_getString)
HXLINE( 407)		bool _hx_tmp = ::hx::IsNull( encoding );
HXLINE( 410)		bool _hx_tmp1;
HXDLIN( 410)		bool _hx_tmp2;
HXDLIN( 410)		if ((pos >= 0)) {
HXLINE( 410)			_hx_tmp2 = (len < 0);
            		}
            		else {
HXLINE( 410)			_hx_tmp2 = true;
            		}
HXDLIN( 410)		if (!(_hx_tmp2)) {
HXLINE( 410)			_hx_tmp1 = ((pos + len) > this->length);
            		}
            		else {
HXLINE( 410)			_hx_tmp1 = true;
            		}
HXDLIN( 410)		if (_hx_tmp1) {
HXLINE( 411)			HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            		}
HXLINE( 419)		::String result = HX_("",00,00,00,00);
HXLINE( 420)		 ::__hxcpp_string_of_bytes(this->b,result,pos,len);
...
::String Bytes_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_498_toString)
HXDLIN( 498)		return this->getString(0,this->length,null());
            	}
