...
HX_LOCAL_STACK_FRAME(_hx_pos_ee759f21a7107475_141___init__,"::ApplicationMain_obj","__init__",0x253d991d,"::ApplicationMain_obj.__init__","bin/linux/haxe/ApplicationMain.hx",141,0x2949457b)
HX_LOCAL_STACK_FRAME(_hx_pos_c0d8ab7ac55c9e24_11_main,"ApplicationMain","main",0x93d2f73e,"ApplicationMain.main","bin/linux/haxe/ApplicationMain.hx",11,0x2949457b)
HX_LOCAL_STACK_FRAME(_hx_pos_c0d8ab7ac55c9e24_20_create,"ApplicationMain","create",0x2f7db141,"ApplicationMain.create","bin/linux/haxe/ApplicationMain.hx",20,0x2949457b)
HX_LOCAL_STACK_FRAME(_hx_pos_c0d8ab7ac55c9e24_123_start,"ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","bin/linux/haxe/ApplicationMain.hx",123,0x2949457b)
...
void ApplicationMain_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_ee759f21a7107475_141___init__)
HXDLIN( 141)		 ::Dynamic init = ::hx::ClassOf< ::lime::app::Application >();
            	}


void ApplicationMain_obj::main(){
            	HX_STACKFRAME(&_hx_pos_c0d8ab7ac55c9e24_11_main)
HXLINE(  12)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Application",30,43,71,0e),::ApplicationMain_obj::create_dyn());
...
void ApplicationMain_obj::create( ::Dynamic config){
            	HX_GC_STACKFRAME(&_hx_pos_c0d8ab7ac55c9e24_20_create)
HXLINE(  26)		 ::justGraphix::application::image::A_PeoteView app =  ::justGraphix::application::image::A_PeoteView_obj::__alloc( HX_CTX );
HXLINE(  27)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("13",e2,2a,00,00));
HXLINE(  28)		app->meta->set(HX_("company",3d,15,69,83),HX_("Justinfront",d8,29,bf,df));
HXLINE(  29)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Application",30,43,71,0e));
HXLINE(  30)		app->meta->set(HX_("name",4b,72,ff,48),HX_("A_PeoteView",f2,db,48,5a));
HXLINE(  31)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("peote.view",e8,7c,35,2b));
HXLINE(  32)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.0.1",35,3d,c8,c1));
HXLINE(  36)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("A_PeoteView",f2,db,48,5a))
            			...
            			->setFixed(13,HX_("frameRate",ad,11,25,39),61)
...
void ApplicationMain_obj::start( ::lime::app::Application app){
            	HX_STACKFRAME(&_hx_pos_c0d8ab7ac55c9e24_123_start)
