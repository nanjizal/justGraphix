...
HX_DEFINE_STACK_FRAME(_hx_pos_e57b760c18d7b49a_35_new,"StringBuf","new",0xaaa8f4b4,"StringBuf.new","StringBuf.hx",35,0x2fd51d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_e57b760c18d7b49a_37_charBufAsString,"StringBuf","charBufAsString",0x54d38cd4,"StringBuf.charBufAsString","StringBuf.hx",37,0x2fd51d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_e57b760c18d7b49a_43_flush,"StringBuf","flush",0xc7c14418,"StringBuf.flush","StringBuf.hx",43,0x2fd51d3c)
HX_LOCAL_STACK_FRAME(_hx_pos_e57b760c18d7b49a_92_toString,"StringBuf","toString",0x68f17bd8,"StringBuf.toString","StringBuf.hx",92,0x2fd51d3c)

void StringBuf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e57b760c18d7b49a_35_new)
            	}
...
::String StringBuf_obj::charBufAsString(){
            	HX_STACKFRAME(&_hx_pos_e57b760c18d7b49a_37_charBufAsString)
...
void StringBuf_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_e57b760c18d7b49a_43_flush)
...
::String StringBuf_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_e57b760c18d7b49a_92_toString)
