...
HXDLIN( 364)		switch((int)(e->_hx_getIndex())){
            			case (int)0: {
HXLINE( 365)				::String v = e->_hx_getString(0);
HXLINE( 366)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXDLIN( 370)							_this3->push(::Std_obj::string(x1));
            			...
            			break;
            			case (int)1: {
HXLINE( 372)				 ::Dynamic e1 = e->_hx_getObject(0);
HXLINE( 373)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXDLIN( 376)								_this7->push(::Std_obj::string(x3));
            			...
            			break;
            			case (int)2: {
HXLINE( 379)				 ::Dynamic e2 = e->_hx_getObject(0);
HXDLIN( 379)				 ::utils::_MultipassTemplate::TemplateExpr eif = e->_hx_getObject(1).StaticCast<  ::utils::_MultipassTemplate::TemplateExpr >();
HXDLIN( 379)				 ::utils::_MultipassTemplate::TemplateExpr eelse = e->_hx_getObject(2).StaticCast<  ::utils::_MultipassTemplate::TemplateExpr >();
HXLINE( 380)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 393)									_this11->b->push(HX_("::end::",9b,f8,09,0d));
            			...
            			break;
            			case (int)3: {
HXLINE( 395)				::String str = e->_hx_getString(0);
HXLINE( 396)				{
...
HXDLIN( 396)						_this13->push(::Std_obj::string(str));
            			...
            			break;
            			case (int)4: {
HXLINE( 397)				 ::haxe::ds::List l = e->_hx_getObject(0).StaticCast<  ::haxe::ds::List >();
HXLINE( 398)				{
...
HXLINE( 399)						this->run(e3);
            			...
            			break;
            			case (int)5: {
HXLINE( 400)				 ::Dynamic e4 = e->_hx_getObject(0);
HXDLIN( 400)				 ::utils::_MultipassTemplate::TemplateExpr loop = e->_hx_getObject(1).StaticCast<  ::utils::_MultipassTemplate::TemplateExpr >();
HXLINE( 401)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 423)									_this16->b->push(HX_("::end::",9b,f8,09,0d));
            			...
            			break;
            			case (int)6: {
HXLINE( 425)				::String m = e->_hx_getString(0);
HXDLIN( 425)				 ::haxe::ds::List params = e->_hx_getObject(1).StaticCast<  ::haxe::ds::List >();
HXDLIN( 425)				{
...
HXLINE( 432)								::String v5 = p->_hx_getString(0);
HXDLIN( 432)								pl->push(this->resolve(v5));
            							}
            							else {
