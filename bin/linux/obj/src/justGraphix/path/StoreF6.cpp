...
HX_DEFINE_STACK_FRAME(_hx_pos_c6bf30c3f40bad9b_3_new,"justGraphix.path.StoreF6","new",0x6f20e377,"justGraphix.path.StoreF6.new","src/justGraphix/path/StoreF6.hx",3,0x0852d34e)
HX_LOCAL_STACK_FRAME(_hx_pos_c6bf30c3f40bad9b_26_push,"justGraphix.path.StoreF6","push",0xcf04b2e3,"justGraphix.path.StoreF6.push","src/justGraphix/path/StoreF6.hx",26,0x0852d34e)
HX_LOCAL_STACK_FRAME(_hx_pos_c6bf30c3f40bad9b_84_shift,"justGraphix.path.StoreF6","shift",0x06ac3359,"justGraphix.path.StoreF6.shift","src/justGraphix/path/StoreF6.hx",84,0x0852d34e)
HX_LOCAL_STACK_FRAME(_hx_pos_c6bf30c3f40bad9b_130_hasNext,"justGraphix.path.StoreF6","hasNext",0x4cd09004,"justGraphix.path.StoreF6.hasNext","src/justGraphix/path/StoreF6.hx",130,0x0852d34e)
HX_LOCAL_STACK_FRAME(_hx_pos_c6bf30c3f40bad9b_136_next,"justGraphix.path.StoreF6","next",0xcda625fc,"justGraphix.path.StoreF6.next","src/justGraphix/path/StoreF6.hx",136,0x0852d34e)
namespace justGraphix{
namespace path{

void StoreF6_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_c6bf30c3f40bad9b_3_new)
...
bool StoreF6_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1d0fcf5b;
}

void StoreF6_obj::push( ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_c6bf30c3f40bad9b_26_push)
...
HXLINE(  41)					this->s6 =  ::justGraphix::path::StoreF6_obj::__alloc( HX_CTX );
            				}
...
HX_DEFINE_DYNAMIC_FUNC1(StoreF6_obj,push,(void))
 ...
 ::Dynamic StoreF6_obj::shift(){
            	HX_STACKFRAME(&_hx_pos_c6bf30c3f40bad9b_84_shift)
...
bool StoreF6_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_c6bf30c3f40bad9b_130_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(StoreF6_obj,hasNext,return )
 ...
 ::Dynamic StoreF6_obj::next(){
            	HX_STACKFRAME(&_hx_pos_c6bf30c3f40bad9b_136_next)
...
::hx::Val StoreF6_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		if (HX_FIELD_EQ(inName,"s6") ) { s6=inValue.Cast<  ::justGraphix::path::StoreF6 >(); return inValue; }
		break;
	case 5:
...
static ::hx::StorageInfo StoreF6_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::justGraphix::path::StoreF6 */ ,(int)offsetof(StoreF6_obj,s6),HX_("s6",63,64,00,00)},
...
void StoreF6_obj::__register()
{
	...
	__mClass->mName = HX_("justGraphix.path.StoreF6",05,5c,06,97);
