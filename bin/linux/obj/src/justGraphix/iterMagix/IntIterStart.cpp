...
HX_DEFINE_STACK_FRAME(_hx_pos_ce652e5f1a6dfe84_10_new,"justGraphix.iterMagix.IntIterStart","new",0x4575350e,"justGraphix.iterMagix.IntIterStart.new","src/justGraphix/iterMagix/IteratorRange.hx",10,0x075ed0dd)
...
bool IntIterStart_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x5a99775c;
}
...
void IntIterStart_obj::__register()
{
	...
	__mClass->mName = HX_("justGraphix.iterMagix.IntIterStart",1c,56,9e,ea);
