...
HX_DEFINE_STACK_FRAME(_hx_pos_15f98640d42fafaa_353_new,"justGraphix.image.U8ArrImg","new",0x58624b87,"justGraphix.image.U8ArrImg.new","src/justGraphix/image/Img.hx",353,0xfcf2ea18)
HX_LOCAL_STACK_FRAME(_hx_pos_15f98640d42fafaa_355_set,"justGraphix.image.U8ArrImg","set",0x586616c9,"justGraphix.image.U8ArrImg.set","src/justGraphix/image/Img.hx",355,0xfcf2ea18)
HX_LOCAL_STACK_FRAME(_hx_pos_15f98640d42fafaa_364_get,"justGraphix.image.U8ArrImg","get",0x585cfbbd,"justGraphix.image.U8ArrImg.get","src/justGraphix/image/Img.hx",364,0xfcf2ea18)
namespace justGraphix{
namespace image{

void U8ArrImg_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_15f98640d42fafaa_353_new)
            	}
...
bool U8ArrImg_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2bc9df8f;
}

static ::justGraphix::image::Iimg_obj _hx_justGraphix_image_U8ArrImg__hx_justGraphix_image_Iimg= {
	( int (::hx::Object::*)(int,int))&::justGraphix::image::U8ArrImg_obj::set,
	( int (::hx::Object::*)(int))&::justGraphix::image::U8ArrImg_obj::get,
};

void *U8ArrImg_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0xd6b2d464: return &_hx_justGraphix_image_U8ArrImg__hx_justGraphix_image_Iimg;
	}
...
int U8ArrImg_obj::set(int index,int value){
            	HX_STACKFRAME(&_hx_pos_15f98640d42fafaa_355_set)
...
int U8ArrImg_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_15f98640d42fafaa_364_get)
...
::hx::ObjectPtr< U8ArrImg_obj > U8ArrImg_obj::__alloc(::hx::Ctx *_hx_ctx) {
	U8ArrImg_obj *__this = (U8ArrImg_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(U8ArrImg_obj), true, "justGraphix.image.U8ArrImg"));
...
void U8ArrImg_obj::__register()
{
	...
	__mClass->mName = HX_("justGraphix.image.U8ArrImg",15,7c,4e,b3);
