...
HX_DEFINE_STACK_FRAME(_hx_pos_17f9836dab40e8f7_235_new,"justGraphix.image.BytesImg","new",0x016c62ba,"justGraphix.image.BytesImg.new","src/justGraphix/image/Img.hx",235,0xfcf2ea18)
HX_LOCAL_STACK_FRAME(_hx_pos_17f9836dab40e8f7_237_set,"justGraphix.image.BytesImg","set",0x01702dfc,"justGraphix.image.BytesImg.set","src/justGraphix/image/Img.hx",237,0xfcf2ea18)
HX_LOCAL_STACK_FRAME(_hx_pos_17f9836dab40e8f7_243_get,"justGraphix.image.BytesImg","get",0x016712f0,"justGraphix.image.BytesImg.get","src/justGraphix/image/Img.hx",243,0xfcf2ea18)
namespace justGraphix{
namespace image{

void BytesImg_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_17f9836dab40e8f7_235_new)
            	}
...
bool BytesImg_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x64a5a142;
}

static ::justGraphix::image::Iimg_obj _hx_justGraphix_image_BytesImg__hx_justGraphix_image_Iimg= {
	( int (::hx::Object::*)(int,int))&::justGraphix::image::BytesImg_obj::set,
	( int (::hx::Object::*)(int))&::justGraphix::image::BytesImg_obj::get,
};

void *BytesImg_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0xd6b2d464: return &_hx_justGraphix_image_BytesImg__hx_justGraphix_image_Iimg;
	}
...
int BytesImg_obj::set(int index,int value){
            	HX_STACKFRAME(&_hx_pos_17f9836dab40e8f7_237_set)
HXLINE( 238)		{
...
int BytesImg_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_17f9836dab40e8f7_243_get)
...
::hx::ObjectPtr< BytesImg_obj > BytesImg_obj::__alloc(::hx::Ctx *_hx_ctx) {
	BytesImg_obj *__this = (BytesImg_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(BytesImg_obj), true, "justGraphix.image.BytesImg"));
...
void BytesImg_obj::__register()
{
	...
	__mClass->mName = HX_("justGraphix.image.BytesImg",c8,3d,2a,ec);
