...
HX_DEFINE_STACK_FRAME(_hx_pos_b6f12f097f92dd08_124_new,"justGraphix.image.ArrIntImg","new",0xd2fd5397,"justGraphix.image.ArrIntImg.new","src/justGraphix/image/Img.hx",124,0xfcf2ea18)
HX_LOCAL_STACK_FRAME(_hx_pos_b6f12f097f92dd08_126_set,"justGraphix.image.ArrIntImg","set",0xd3011ed9,"justGraphix.image.ArrIntImg.set","src/justGraphix/image/Img.hx",126,0xfcf2ea18)
HX_LOCAL_STACK_FRAME(_hx_pos_b6f12f097f92dd08_132_get,"justGraphix.image.ArrIntImg","get",0xd2f803cd,"justGraphix.image.ArrIntImg.get","src/justGraphix/image/Img.hx",132,0xfcf2ea18)
namespace justGraphix{
namespace image{

void ArrIntImg_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b6f12f097f92dd08_124_new)
            	}
...
bool ArrIntImg_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7ed2cd7b;
}

static ::justGraphix::image::Iimg_obj _hx_justGraphix_image_ArrIntImg__hx_justGraphix_image_Iimg= {
	( int (::hx::Object::*)(int,int))&::justGraphix::image::ArrIntImg_obj::set,
	( int (::hx::Object::*)(int))&::justGraphix::image::ArrIntImg_obj::get,
};

void *ArrIntImg_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0xd6b2d464: return &_hx_justGraphix_image_ArrIntImg__hx_justGraphix_image_Iimg;
	}
...
int ArrIntImg_obj::set(int index,int value){
            	HX_STACKFRAME(&_hx_pos_b6f12f097f92dd08_126_set)
...
int ArrIntImg_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_b6f12f097f92dd08_132_get)
...
::hx::ObjectPtr< ArrIntImg_obj > ArrIntImg_obj::__alloc(::hx::Ctx *_hx_ctx) {
	ArrIntImg_obj *__this = (ArrIntImg_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(ArrIntImg_obj), true, "justGraphix.image.ArrIntImg"));
...
void ArrIntImg_obj::__register()
{
	...
	__mClass->mName = HX_("justGraphix.image.ArrIntImg",25,3c,a0,0b);
