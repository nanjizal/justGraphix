...
#define INCLUDED_justGraphix_image_StackIntImg
...
HX_DECLARE_CLASS2(justGraphix,image,StackIntImg)
...
class HXCPP_CLASS_ATTRIBUTES StackIntImg_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x0b82dc2e };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="justGraphix.image.StackIntImg")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"justGraphix.image.StackIntImg"); }
...
#endif /* INCLUDED_justGraphix_image_StackIntImg */ 
