...
#define INCLUDED_justGraphix_contour3D_io__FloatColorTriangles_FloatColorTriangles_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS4(justGraphix,contour3D,io,_FloatColorTriangles,FloatColorTriangles_Impl_)
...
class HXCPP_CLASS_ATTRIBUTES FloatColorTriangles_Impl__obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x28b202df };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="justGraphix.contour3D.io._FloatColorTriangles.FloatColorTriangles_Impl_")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"justGraphix.contour3D.io._FloatColorTriangles.FloatColorTriangles_Impl_"); }
		...
		inline static ::hx::ObjectPtr< FloatColorTriangles_Impl__obj > __alloc(::hx::Ctx *_hx_ctx) {
			FloatColorTriangles_Impl__obj *__this = (FloatColorTriangles_Impl__obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FloatColorTriangles_Impl__obj), false, "justGraphix.contour3D.io._FloatColorTriangles.FloatColorTriangles_Impl_"));
...
#endif /* INCLUDED_justGraphix_contour3D_io__FloatColorTriangles_FloatColorTriangles_Impl_ */ 
