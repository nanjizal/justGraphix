...
class HXCPP_CLASS_ATTRIBUTES Program_obj : public ::hx::Object
{
	...
	public:
		...
		int glBlendDstAlpha;
		int glBlendFunc;
		int glBlendFuncAlpha;
		bool useBlendColor;
		bool useBlendColorSeparate;
		int blendColor;
		Float glBlendR;
		Float glBlendG;
		Float glBlendB;
		...
		::Dynamic buffer;
		 ...
		 ::peote::view::intern::RenderList_peote_view_ActiveTexture textureList;
		 ::peote::view::intern::RenderList_peote_view_ActiveTexture textureListPicking;
		...
		int getTextureIndexByIdentifier(::String identifier,::hx::Null< bool >  addNew);
		::Dynamic getTextureIndexByIdentifier_dyn();

		void setTexture( ::peote::view::Texture texture,::String identifier, ::Dynamic autoUpdateTextures);
		::Dynamic setTexture_dyn();

		void updateTextures();
		::Dynamic updateTextures_dyn();

		 ::peote::view::intern::RenderListItem_peote_view_ActiveTexture textureListItem;
};
